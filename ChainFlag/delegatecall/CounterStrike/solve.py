...
# v4.local.K1liRt8a5S22fnzqIdVwLY5ppxO13w9KC0VU0eEtIfJngPa09wRHOPJixhOVaTueaH6gkg-7vi0KoDIYcd2L_aPaHC9DUZbZFvuBlfipNBhdOhPC2YceuyqZVojhe8DQsnkoI_3ex0-Df7K1KdAszRHzO0wn5cHTwBUl8mTtqBv5YQ
# Set to
IS_TEST = True
TARGET = 0xcA15D40ec843933E2AA7D3d3E7761085891CFC3D

# Select RPC provider
if IS_TEST:
    RPC = "http://localhost:8545/"
    ARCHIVE_URL = "https://eth-ropsten.alchemyapi.io/v2/X4AYbMxPCINdJX9JS6c1SRCelmiM6DXm"
    BLOCK_NUMBER = 11930273
    TEST_BALANCE = Web3.toWei(1, 'ether')
else:
    RPC = "https://eth-ropsten.alchemyapi.io/v2/X4AYbMxPCINdJX9JS6c1SRCelmiM6DXm"
...
_nonces = {}
_chain_ids_cache = {}
def mk_transaction(w3, account, tx, iscall):
    global _nonces
...
def sign_and_send_transaction(w3, account, tx):
    tx = mk_transaction(w3, account, tx, iscall=False)
